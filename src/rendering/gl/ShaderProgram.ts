...
class ShaderProgram {
  ...
  unifPerlinScale: WebGLUniformLocation;
  ...
  constructor(shaders: Array<Shader>) {
    ...
    this.unifPerlinScale = gl.getUniformLocation(this.prog, "u_PerlinScale");
  }
  ...
  setPerlinScale(scale: number){
    this.use();
    if (this.unifPerlinScale !== -1){
      gl.uniform1f(this.unifPerlinScale, scale);
    }
  }
